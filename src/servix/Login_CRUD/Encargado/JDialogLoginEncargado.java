...
public class JDialogLoginEncargado extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("* si es la primera vez iniciando sesion la contraseña es 1234");
    ...
    private void jButtonIniciarSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonIniciarSesionActionPerformed
        ...
        if(comprobarDatos(jTextFielduser.getText(), stringContrasena)){
             if(comprobarInicioSesion(jTextFielduser.getText())==false){
                ...
                this.dispose();
                JDialogEditarEncargado jdee = new JDialogEditarEncargado(this, true);
    ...
    public boolean comprobarInicioSesion(String user){
        try {
            nueva.conectar();
            String sql = "SELECT haIniciadoSesion FROM Encargado WHERE usuario_login = ?";
            PreparedStatement ps = conexion.prepareStatement(sql);
            ps.setString(1, user);
            ResultSet rs = ps.executeQuery();
