...
public class JDialogEditarUsuario extends javax.swing.JDialog {
    ...
    String id;
    JFrameServix padre;
    public JDialogEditarUsuario(String id, java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
             ...
             JOptionPane.showConfirmDialog(rootPane,
                ...
                if(stringContrasena1.equals(stringContrasena2)){ // Se comprueba que las contraseñas sean iguales
                     ...
                     try {
                         ...
                         System.getLogger(JDialogEditarUsuario.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
                    }
                }else{
                     JOptionPane.showConfirmDialog(rootPane,
